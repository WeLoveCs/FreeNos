...
#define JAVA_HOME "/usr/lib/jvm/default-java"
...
#define HADOOP_CONF_DIR "/usr/local/hadoop/etc/hadoop"
...
#define PATH "/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/snap/bin:/snap/bin:/usr/local/hadoop/bin"
